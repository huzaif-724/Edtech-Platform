  ...
  return (
    <div className=" min-h-screen h-auto flex flex-col-reverse md:flex-row gap-4 w-full">
      <div className=" w-[95%] mx-auto md:w-[40%] lg:w-[25%] min-h-screen lg:bg-richblack-800 ">
        <h1 className=" text-white hidden md:block pt-10  md:pt-24 text-[18px] font-bold pl-5">
          {course?.title}
        </h1>
        <div className="  md:w-[90%] mx-auto pt-4 hidden  lg:flex items-center border-b-2 border-richblack-700"></div>
      ...
      <div className="w-[95%] flex-col mx-auto md:mt-16 lg:mt-20 sm:h-[300px] md:h-[400px] lg:h-[600px] flex justify-center items-center">
        {selectedVideo ? (
          <video
            key={selectedVideo}
            src={selectedVideo}
